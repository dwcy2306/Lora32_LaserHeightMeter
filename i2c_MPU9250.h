...
public:
    ...
    inline void setGSensitivity(const uint8_t gScaleRange = VAL_GYRO_FS_0250)
    {
    ...
    inline void setASensitivity(const uint8_t aScaleRange = VAL_ACCEL_FS_02)
    {
    ...
    inline uint8_t initialize(void)
    {
        ...
        setASensitivity(VAL_ACCEL_FS_02);
